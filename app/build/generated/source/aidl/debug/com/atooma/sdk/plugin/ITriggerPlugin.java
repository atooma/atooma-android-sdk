 ...
 * Original file: /opt/monossido/ATOOMA/AppGithub/atooma-android-sdk1/app/src/main/aidl/com/atooma/sdk/plugin/ITriggerPlugin.aidl
 */
package com.atooma.sdk.plugin;
public interface ITriggerPlugin extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.atooma.sdk.plugin.ITriggerPlugin
{
private static final java.lang.String DESCRIPTOR = "com.atooma.sdk.plugin.ITriggerPlugin";
...
/**
 * Cast an IBinder object into an com.atooma.sdk.plugin.ITriggerPlugin interface,
 * generating a proxy if needed.
 */
public static com.atooma.sdk.plugin.ITriggerPlugin asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.atooma.sdk.plugin.ITriggerPlugin))) {
return ((com.atooma.sdk.plugin.ITriggerPlugin)iin);
}
return new com.atooma.sdk.plugin.ITriggerPlugin.Stub.Proxy(obj);
}
...
private static class Proxy implements com.atooma.sdk.plugin.ITriggerPlugin
{
...
@Override public void invoke(java.lang.String ruleId, com.atooma.sdk.plugin.ParameterBundle parameters) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_invoke = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
...
public void invoke(java.lang.String ruleId, com.atooma.sdk.plugin.ParameterBundle parameters) throws android.os.RemoteException;
