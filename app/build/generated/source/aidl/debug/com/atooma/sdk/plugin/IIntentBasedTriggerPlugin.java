 ...
 * Original file: /opt/monossido/ATOOMA/AppGithub/atooma-android-sdk1/app/src/main/aidl/com/atooma/sdk/plugin/IIntentBasedTriggerPlugin.aidl
 */
package com.atooma.sdk.plugin;
public interface IIntentBasedTriggerPlugin extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.atooma.sdk.plugin.IIntentBasedTriggerPlugin
{
private static final java.lang.String DESCRIPTOR = "com.atooma.sdk.plugin.IIntentBasedTriggerPlugin";
...
/**
 * Cast an IBinder object into an com.atooma.sdk.plugin.IIntentBasedTriggerPlugin interface,
 * generating a proxy if needed.
 */
public static com.atooma.sdk.plugin.IIntentBasedTriggerPlugin asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.atooma.sdk.plugin.IIntentBasedTriggerPlugin))) {
return ((com.atooma.sdk.plugin.IIntentBasedTriggerPlugin)iin);
}
return new com.atooma.sdk.plugin.IIntentBasedTriggerPlugin.Stub.Proxy(obj);
}
...
this.receive(_arg0, _arg1, _arg2);
reply.writeNoException();
return true;
}
...
case TRANSACTION_getIntentFilter:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _result = this.getIntentFilter();
reply.writeNoException();
reply.writeString(_result);
return true;
}
...
private static class Proxy implements com.atooma.sdk.plugin.IIntentBasedTriggerPlugin
{
...
@Override public void receive(java.lang.String ruleId, com.atooma.sdk.plugin.ParameterBundle parameters, android.os.Bundle bundleIntent) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_data.writeInt(1);
bundleIntent.writeToParcel(_data, 0);
}
else {
_data.writeInt(0);
}
...
@Override public java.lang.String getIntentFilter() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getIntentFilter, _data, _reply, 0);
_reply.readException();
_result = _reply.readString();
}
finally {
...
static final int TRANSACTION_receive = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
...
static final int TRANSACTION_getIntentFilter = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
}
...
public void receive(java.lang.String ruleId, com.atooma.sdk.plugin.ParameterBundle parameters, android.os.Bundle bundleIntent) throws android.os.RemoteException;
...
public java.lang.String getIntentFilter() throws android.os.RemoteException;
}
